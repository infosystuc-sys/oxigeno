  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-6">
      <div className="bg-white rounded-2xl shadow-lg p-10 max-w-md w-full text-center">
        ...
        <h2 className="text-2xl font-bold text-gray-800 mb-1">Recepción guardada</h2>
        <p className="text-gray-400 mb-4">Ingresada correctamente en Tango Gestión</p>
...
export function RecepcionForm() {
  ...
  // ── Búsqueda de proveedor (debounce 300ms) ────────────────────────────────
  useEffect(() => {
  ...
  // ── Confirmar slot actual y dejarlo vacío para el próximo gas ────────────
  ...
  // ── Limpiar slot actual (descarta series no confirmadas) ──────────────────
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      {/* Header */}
      <header className="bg-blue-700 text-white px-8 py-4 shadow-md flex items-center gap-3">
        <svg className="w-7 h-7 opacity-80" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
            d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10" />
        </svg>
        <h1 className="text-xl font-bold tracking-wide">Oxigeno — Informe de Recepción</h1>
      </header>
        ...
        <div className="grid grid-cols-5 gap-6 items-start">
          ...
          <div className="col-span-3 space-y-5">
            ...
            <section className="bg-white rounded-2xl shadow p-6 space-y-5">
              ...
              <div>
                <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1.5">
                  Nro. Remito Proveedor <span className="text-red-400">*</span>
                </label>
                <input
                  type="text"
                  value={remito}
              ...
              <div>
                ...
                {proveedor ? (
                  <div className="flex items-center gap-3 border border-green-400 bg-green-50 rounded-xl px-4 py-3">
                    <span className="font-mono text-sm text-gray-400 shrink-0">{proveedor.cod_provee}</span>
                      ...
                      <ul className="absolute z-30 w-full mt-1.5 bg-white border border-gray-200
                        ...
                        {provResults.map(p => (
                          <li key={p.cod_provee}>
                            ...
                            >
                              <span className="font-mono text-sm text-gray-400 w-16 shrink-0">{p.cod_provee}</span>
                              <span className="text-sm text-gray-800">{p.NOM_PROVEE}</span>
                            </button>
                          </li>
                        ))}
                      </ul>
          ...
          {/* ══ Columna derecha: cilindros en tiempo real (40%) ══════════════ */}
